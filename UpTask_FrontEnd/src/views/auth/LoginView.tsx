...
export default function LoginView() {
    ...
    const handleLogin = (formData: UserLoginForm) => mutate(formData); // // Llama a la función de mutación
    ...
    return (
        <>
            ...
            <form
                ...
                className="space-y-8 p-10 mt-10 bg-white shadow-lg rounded-lg"
                noValidate
            >
            ...
            <nav className="mt-10 flex flex-col space-y-4">
                ...
                <Link
                    to={'/auth/register'}
                    className="text-center text-gray-300 font-normal"
                >¿No tienes cuenta? Crea Una Ahora Mismo</Link>
            </nav>
        </>
    )
}